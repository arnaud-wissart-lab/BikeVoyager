...
import { useAddressBookSlice } from '../../features/data/useAddressBookSlice'
import { useCloudSlice } from '../../features/cloud/useCloudSlice'
import { useVisiblePois } from '../../features/pois/useVisiblePois'
import { usePlannerSlice } from '../../features/routing/usePlannerSlice'
...
export default function AppContainer() {
  ...
  const { hasPoiCategories, visiblePoiItems } = useVisiblePois({
    poiCategories,
    poiItems,
  })
  const {
