...
internal static class OverpassCorridorMath
{
    ...
    public static SegmentPairProjection ProjectSegmentToSegmentMeters(
        double routeALat,
        double routeALon,
        double routeBLat,
        double routeBLon,
    ...
    public static SegmentProjection ProjectPointToSegmentMeters(
        double lat,
        double lon,
        double latA,
        double lonA,
