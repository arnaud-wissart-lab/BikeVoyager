...
import PlannerPage from './features/app/components/PlannerPage'
import MapPage from './features/app/components/MapPage'
import ProfilesPage from './features/app/components/ProfilesPage'
import DataPage from './features/app/components/DataPage'
import HelpPage from './features/app/components/HelpPage'
import {
...
import useHashRoute from './features/app/useHashRoute'
import useMapPageController from './features/app/useMapPageController'
...
const hasPlannerDraftData = (draft: PlannerDraft) =>
  draft.mode !== null ||
  draft.tripType !== null ||
...
const deduplicatePoiItems = (items: PoiItem[]) => {
...
export default function App() {
  ...
  const visibleAddressBookEntries = useMemo(() => {
    ...
    return addressBook.filter((entry) => entry.tags.includes(addressBookFilterTag))
  }, [addressBook, addressBookFilterTag])
  ...
  const helperItems = [
    ...
    {
      key: 'distance',
      show: tripType === 'loop' && !isDistanceValid,
  ...
  const visibleAddressBookCount = visibleAddressBookEntries.length
